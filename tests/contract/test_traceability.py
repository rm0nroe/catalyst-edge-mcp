...
def test_technical specification_TRACEABILITY_IDENTIFIERS_ARE_DISCOVERABLE():
    root = Path(__file__).parents[2]
    required = set(re.findall(r"`((?:UT|CT|PT|FX)_[A-Z0-9_*]+)`", (root / "technical specification").read_text()))
