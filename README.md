...
[`GTM_PLAN.md`](https://github.com/rm0nroe/catalyst-edge-mcp/blob/main/GTM_PLAN.md); the economics are documented in the
[`Hosted Pro architecture research`](https://github.com/rm0nroe/catalyst-edge-mcp/blob/main/thoughts/unknown-ticket/research/2026-08-03-RESEARCH-hosted-pro-architecture.md).
...
See [TDD.md](https://github.com/rm0nroe/catalyst-edge-mcp/blob/main/TDD.md) for exact formulas, provider contracts, compactness rules, and
